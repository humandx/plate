...
## @humandx/plate-ui-dnd@20.0.0

### Major Changes

- [#2237](https://github.com/udecode/plate/pull/2237) by [@tmorane](https://github.com/tmorane) – Unstyled logic has been moved to `@humandx/plate-dnd`
  ...
  Only `withPlateDraggable`, `withPlateDraggables` and `PlateDraggable` are left in `@humandx/plate-ui-dnd`.
  Renamed:
...
## @humandx/plate-ui-table@20.0.0

### Major Changes

- [#2251](https://github.com/udecode/plate/pull/2251) by [@zbeyens](https://github.com/zbeyens) – Headless components and hooks moved to `@humandx/plate-table`, so the following components have been renamed:
...
## @humandx/plate-code-block@17.0.0
...
## @humandx/plate@16.0.0

## @humandx/plate-headless@16.0.0
...
## @humandx/plate-ui-button@15.0.0
...
## @humandx/plate-ui-popper@15.0.0

### Major Changes

- [#1677](https://github.com/udecode/plate/pull/1677) by [@zbeyens](https://github.com/zbeyens) –
- deprecated, use instead `@humandx/plate-floating`

## @humandx/plate-ui-toolbar@15.0.0

### Major Changes

- [#1677](https://github.com/udecode/plate/pull/1677) by [@zbeyens](https://github.com/zbeyens) –
- remove `@humandx/plate-ui-popper` and `react-popper` deps for `@humandx/plate-floating`
- `BalloonToolbarProps`:
...
## @humandx/plate@13.0.0

## @humandx/plate-headless@13.0.0
...
## @humandx/plate-ui@13.0.0

## @humandx/plate-ui-dnd@13.0.0
...
## @humandx/plate-styled-components@11.0.0
...
## @humandx/plate-ui-toolbar@10.0.0
...
## @humandx/plate-indent-list@8.0.0
...
## @humandx/plate-find-replace@8.0.0

- [#1234](https://github.com/udecode/plate/pull/1234) by [@zbeyens](https://github.com/zbeyens) – Removed:
  - `useFindReplacePlugin` for `createFindReplacePlugin`

## @humandx/plate-alignment@8.0.0
...
## @humandx/plate-basic-marks@8.0.0
