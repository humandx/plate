export const createHugeDocumentValueCode = `/** @jsxRuntime classic */
/** @jsx jsx */
...
export const createHugeDocumentValueFile = {
  '/huge-document/createHugeDocumentValue.tsx': createHugeDocumentValueCode,
};
