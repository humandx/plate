export const editableVoidElementCode = `import React, { CSSProperties, useState } from 'react';
import {
...
export const editableVoidElementFile = {
  '/editable-voids/EditableVoidElement.tsx': editableVoidElementCode,
};
