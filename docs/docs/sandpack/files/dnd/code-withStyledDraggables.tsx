export const withStyledDraggablesCode = `import React from 'react';
...
export const withStyledDraggablesFile = {
  '/dnd/withStyledDraggables.tsx': withStyledDraggablesCode,
};
