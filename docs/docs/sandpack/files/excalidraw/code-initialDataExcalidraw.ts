export const initialDataExcalidrawCode = `import { TNodeProps } from '@humandx/plate'
...
export const initialDataExcalidrawFile = {
  '/excalidraw/initialDataExcalidraw.ts': initialDataExcalidrawCode,
};
