export const basicPluginsComponentsAppCode = `import React from 'react';
import {
...
export const basicPluginsComponentsAppFile = {
  '/BasicPluginsComponentsApp.tsx': basicPluginsComponentsAppCode,
};
